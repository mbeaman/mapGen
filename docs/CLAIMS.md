...
> **Trade & embargo surfacing — DONE in Phase 3 (below).** Capacity/population were SimState-internal; Phase 3 added the `Nation::prosperity` channel (v21) + a prosperity heatmap, a trade-route lens, and chronicle weaving. The remaining arc work is the rest of Phase 3 (narrator/arc weaving beyond the focal selector, first-contact beats).
