...
> **Trade & embargo surfacing — DONE in Phase 3 (below).** Capacity/population were SimState-internal; Phase 3 added the `Nation::prosperity` channel (v21) + a prosperity heatmap, a trade-route lens, chronicle weaving, and (increment 2) the **first-contact arc** — the narrator weaves a sea route's birth AND its severance into one Sundered-Lane chronicle. The remaining arc work is the rest of Phase 3 (temporal surfacing of the diffusion/faith timeline; cross-lens correlation).
